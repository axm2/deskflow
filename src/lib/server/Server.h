...
private:
  ...
  void onKeyDown(KeyID, KeyModifierMask, KeyButton, const std::string &, const char *screens, bool activeScreenOnly);
  void onKeyUp(KeyID, KeyModifierMask, KeyButton, const char *screens, bool activeScreenOnly);
