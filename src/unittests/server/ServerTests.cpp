...
void ServerTests::activeScreenOnly_forwardsOriginalKeystroke()
{
  ...
  auto *keyInfo =
      IKeyState::KeyInfo::alloc(remappedKey, remappedMask, 0, 0, targetScreens, true, originalKey, originalMask);
  ...
  auto *keyInfo2 = IKeyState::KeyInfo::alloc(remappedKey, remappedMask, 0, 0, targetScreens, false, 0, 0);
